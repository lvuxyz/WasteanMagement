class ApiConstants {
  ...
  static const String _localBaseUrl = 'http://localhost:5000/api/v1'; // Localhost cho testing
  
  // Chọn URL dựa trên môi trường
  static String get baseUrl => useEmulator ? _emulatorBaseUrl : _localBaseUrl;
